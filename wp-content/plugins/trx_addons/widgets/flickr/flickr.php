...
if ( !function_exists( 'trx_addons_widget_flickr_load_scripts_front' ) ) {
	...
	function trx_addons_widget_flickr_load_scripts_front() {
		if (trx_addons_is_on(trx_addons_get_option('debug_mode'))) {
			trx_addons_enqueue_style( 'trx_addons-widget_flickr', trx_addons_get_file_url('widgets/flickr/flickr.css'), array(), null );
		}
	}
}
...
if (!function_exists('trx_addons_widget_flickr_reg_shortcodes_vc')) {
	function trx_addons_widget_flickr_reg_shortcodes_vc() {
		...
		vc_map( apply_filters('trx_addons_sc_map', array(
				...
				"name" => esc_html__("Widget Flickr photos", 'trx_addons'),
	...
	add_action('after_setup_theme', 'trx_addons_widget_flickr_reg_shortcodes_vc', 11);
}
?>