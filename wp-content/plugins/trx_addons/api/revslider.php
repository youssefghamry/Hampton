...
if ( !function_exists( 'trx_addons_revslider_importer_export' ) ) {
	...
	function trx_addons_revslider_importer_export($importer) {
		// Sliders list
		trx_addons_fpc(trx_addons_get_file_dir('importer/export/revslider.txt'), join("\n", array_keys(trx_addons_get_list_revsliders())));
	}
}

// Display exported data in the fields
if ( !function_exists( 'trx_addons_buddypress_importer_export_fields' ) ) {
	//add_action( 'trx_addons_action_importer_export_fields',	'trx_addons_buddypress_importer_export_fields', 10, 1 );
	function trx_addons_buddypress_importer_export_fields($importer) {
