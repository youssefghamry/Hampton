...
?><div id="<?php echo esc_attr($args['id']); ?>_wrap" class="sc_googlemap_wrap"><?php
	...
	?><div id="<?php echo esc_attr($args['id']); ?>"
			class="sc_googlemap sc_googlemap_detailed<?php echo (!empty($args['class']) ? ' '.esc_attr($args['class']) : ''); ?>"
	...
	if ($args['content']) {
		?><div class="sc_googlemap_content sc_googlemap_content_detailed"><?php echo trim($args['content']); ?></div><?php
	}
