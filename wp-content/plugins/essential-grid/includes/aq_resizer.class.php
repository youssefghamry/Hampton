...
if (!class_exists('Essential_Grid_Aqua_Resize')) {
	
	class Essential_Grid_Aqua_Resize
	{
		/**
...
if (!function_exists('esg_aq_resize')) {
	/**
	 * This is just a tiny wrapper function for the class above so that there is no
	 * need to change any code in your own WP themes. Usage is still the same :)
	 */
	function esg_aq_resize($url, $width = null, $height = null, $crop = null, $single = true, $upscale = false)
	{
		$aq_resize = Essential_Grid_Aqua_Resize::getInstance();
